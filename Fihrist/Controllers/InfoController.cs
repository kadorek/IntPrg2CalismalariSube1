...
namespace Fihrist.Controllers
{
    ...
    {
        private readonly FihristContext _context;

        public InfoController()
        {
            _context = new FihristContext();
        }

        // GET: Info
        public async Task<IActionResult> Index()
        {
            var fihristContext = _context.Infos.Include(i => i.Person).Include(i => i.Type);
            return View(await fihristContext.ToListAsync());
        }
        ...
        {
            info.Type = _context.Types.FirstOrDefault(x => x.Id == info.TypeId);
            info.Person = _context.People.FirstOrDefault(x => x.Id == info.PersonId);
            ...
            ViewData["PersonId"] = new SelectList(_context.People, "Id", "Fullname", info.PersonId);
            ViewData["TypeId"] = new SelectList(_context.Types, "Id", "Name", info.TypeId);
            return View(info);
        }
